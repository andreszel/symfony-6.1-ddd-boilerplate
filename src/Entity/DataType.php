...
class DataType
{
    ...
    #[ORM\OneToMany(mappedBy: 'dataTypeId', targetEntity: OwnerData::class, orphanRemoval: true)]
    ...
    public function removeOwnerData(OwnerData $ownerData): self
    {
        if ($this->ownerData->removeElement($ownerData)) {
            ...
            if ($ownerData->getDataTypeId() === $this) {
                $ownerData->setDataTypeId(null);
            }
        }
