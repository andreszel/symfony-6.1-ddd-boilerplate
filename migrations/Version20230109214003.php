 ...
 */
final class Version20230109214003 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE log_type (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, is_login TINYINT(1) DEFAULT 0 NOT NULL, is_logout TINYINT(1) DEFAULT 0 NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_log (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, log_type_id INT NOT NULL, session_id VARCHAR(255) NOT NULL, remote_addr VARCHAR(255) NOT NULL, user_agent VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_6429094EA76ED395 (user_id), INDEX IDX_6429094EFD81B404 (log_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE user_log ADD CONSTRAINT FK_6429094EFD81B404 FOREIGN KEY (log_type_id) REFERENCES log_type (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_log DROP FOREIGN KEY FK_6429094EFD81B404');
